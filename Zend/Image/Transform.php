...
class Zend_Image_Transform extends Zend_Image
{
    ...
    public function fitToWidth( $targetWidth )
    {
        ...
        $targetHeight = (int) ( $sourceHeight / $sourceWidth * $targetWidth );
    ...
    public function fitToHeight( $targetHeight )
    {
        ...
        $targetWidth = (int) ( $sourceWidth / $sourceHeight * $targetHeight );
    ...
    public function crop( $width, $height )
    {
        ...
        if ( $this->_center ) {
            $leftOffset = (int)( ( $this->getWidth() - $width ) / 2 );
        }

        if ( $this->_middle ) {
            $topOffset = (int)( ( $this->getHeight() - $height ) / 2 );
        }
